// ProfileOrderCard.jsx
// UI card component to display a single order in profile section
// - Shows order ID, date, payment status & method
// - Displays customer info (name, phone, address)
// - Renders list of purchased items with quantities & prices
// - Ends with order summary (total amount)
		...
		<Card className="rounded-2xl shadow-sm hover:shadow-md transition">
			...
			<CardContent className="space-y-3 text-sm">
				...
				<div className="flex justify-between items-center font-medium">
					...
					<span className="text-primary font-roboto">
