...
import { Truck, ShieldCheck, RefreshCcw, PlusIcon, MinusIcon, Heart } from "lucide-react";
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "DECREMENT": return { quantity: Math.max(state.quantity - 1, 0) };
    case "SET": return { quantity: action.payload };
